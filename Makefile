...
default:
	tar --exclude='venv' --exclude='__pycache__/' --exclude="cpu" --exclude="notes" --exclude="config.json" --exclude="robinhood.pickle" --exclude="trades.pickle" -zcvf /tmp/tradebot.tar.xz .
